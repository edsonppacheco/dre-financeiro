...
const icones: Record<string, ReactNode> = {
  ...
  planejamento: I(<><rect x="3" y="4" width="18" height="17" rx="2" /><path d="M3 9h18M8 2v4M16 2v4M8 14l2.5 2.5L15 12" /></>),
...
const LINKS = [
  ...
  { href: '/planejamento', label: 'Planejamento', icon: 'planejamento' },
